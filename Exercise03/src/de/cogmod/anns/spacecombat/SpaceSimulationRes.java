...
public class SpaceSimulationRes {
	...
	static {
		try {
			//
			IMG_ENEMY     = ImageIO.read(load("de/cogmod/anns/spacecombat/resources/tiefighter.png"));
			IMG_ENEMY_REL = ((double)(IMG_ENEMY.getHeight()) / ((double)(IMG_ENEMY.getWidth())));
			//
			IMG_SPACE     = ImageIO.read(load("de/cogmod/anns/spacecombat/resources/space.jpg"));
            //
            IMG_COCKPIT   = ImageIO.read(load("de/cogmod/anns/spacecombat/resources/cockpit.png"));
            //
            IMG_MISSILE   = ImageIO.read(load("de/cogmod/anns/spacecombat/resources/missile.png"));
            //
            IMG_EXPLOSION = ImageIO.read(load("de/cogmod/anns/spacecombat/resources/explosion.png"));
            //
            {
                final int framesx     = 8;
                final int framesy     = 6;
